// I updated but check once more - the 'day' variable shouldn't be a string if testing against a number (e.g "< 31" etc..)
...
export const updateDate = (day, month, year) => {
  ...
  } else if (month !== '12' && month !== '11' && month !== '10' && month !== '09') {
